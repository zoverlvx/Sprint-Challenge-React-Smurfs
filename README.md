...
- [ ] Explain the differences between `client-side routing` and `server-side routing`.
	...
	A: Basically server-side routing will give you an entirely new page and refresh the browser whereas client-side routing will merely change the state of the application and maybe request data from a server, but it won't refresh the page and only make changes to components. 
